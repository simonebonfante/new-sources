		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8" id="main" style="margin-top:10%;">
			...
			<div id="maincontent">
				<div id="main1" class="hide">
					<form id="create" method="post" action="php/create_gestione.php" class="form-horizontal">
						<div class="form-group">
							<label for="spantitle" class="col-sm-2 control-label">Title:</label>
							<div class="col-sm-10">
								<span class="" id="spantitle"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="spanauth" class="col-sm-2 control-label">Author:</label>
							<div class="col-sm-10">
								<span class="" id="spanauth"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="spandesc" class="col-sm-2 control-label">Description:</label>
							<div class="col-sm-10">
								<span class="" id="spandesc"></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="spanstatus">Status:</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="submit" name="Submit" value="cre" class="btn btn-default">Create</button>
							</div>
						</div>
					</form>
				</div>
				<div id="main2" class="">
					...
					<form id="formpub" name="formpub" method="post" action="php/loadrules.php">
